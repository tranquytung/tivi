...
class QueueRestProxy extends ServiceRestProxy implements IQueue
{
    ...
    /**
     * Returns queue properties, including users-defined metadata.
     *
     * @param string              $queueName The queue name.
     * @param QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Creates promise to return queue properties, including users-defined metadata.
     *
     * @param string              $queueName The queue name.
     * @param QueueServiceOptions $options   The optional parameters.
     *
    ...
    /**
     * Sets users-defined metadata on the queue. To delete queue metadata, call
    ...
    /**
     * Creates promise to set users-defined metadata on the queue. To delete
