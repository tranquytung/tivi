...
class CreateDirectoryOptions extends FileServiceOptions
{
    ...
    /**
     * Sets users defined metadata. This metadata should be added without the header
     * prefix (x-ms-meta-*).
     *
     * @param array $metadata users defined metadata object in array form.
     *
     * @return void
     */
