...
class ServiceRestProxy extends RestProxy
{
     ...
     *
     * @param  ServiceOptions  $serviceOptions The options users passed in.
     *
     * @return MiddlewareStack
     */
    protected function createMiddlewareStack(ServiceOptions $serviceOptions)
    {
        //If handler stack is not defined by the users, create a default
        //middleware stack.
        $stack = null;
     ...
     * @param array $metadata users specified metadata
     *
     * @return array
     */
     ...
     *
     * @param array $metadata users defined metadata.
     *
     * @return array
     */
    ...
    private static function addLocationHeaderToResponse(
        ...
        //that the users have not set a retry middleware.
