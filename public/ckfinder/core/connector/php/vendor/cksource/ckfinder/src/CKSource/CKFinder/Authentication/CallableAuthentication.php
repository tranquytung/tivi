 ...
 *
 * Basic CKFinder authentication class that authenticates the current users
...
class CallableAuthentication implements AuthenticationInterface
{
    ...
    /**
     * @return bool `true` if the current users was successfully authenticated within CKFinder.
     */
