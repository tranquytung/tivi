...
class Client
{
    ...
    /**
     * Copy a file or folder to a different location in the users's Dropbox.
     *
    ...
    /**
     * Download a file from a users's Dropbox.
     *
     * @param string $path
     *
     * @return resource
     ...
     * with same parameters are made simultaneously by same API app for same users. If your app implements
    ...
    /**
     * Move a file or folder to a different location in the users's Dropbox.
     *
