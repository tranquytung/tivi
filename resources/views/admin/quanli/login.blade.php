<!DOCTYPE html>
    ...
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{ url('admin_theme/plugins/iCheck/square/blue.css') }}">
        ...
        <body class="hold-transition login-page">
            ...
            <!-- iCheck -->
            <script src="{{ url('admin_theme/plugins/iCheck/icheck.min.js') }} "></script>
            <script>
                $(function () {
                    $('input').iCheck({
